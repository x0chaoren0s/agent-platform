...
| Shortcut | 说明 |
|----------|------|
| [`+move`](skills/lark-wiki/references/lark-wiki-move.md) | Move a wiki node, or move a Drive document into Wiki |
| [`+node-create`](skills/lark-wiki/references/lark-wiki-node-create.md) | Create a wiki node with automatic space resolution |
| [`+delete-space`](skills/lark-wiki/references/lark-wiki-delete-space.md) | Delete a wiki space, polling the async delete task when needed |
