...
> **前置条件：** 先阅读 [`skills/lark-shared/SKILL.md`](skills/lark-shared/SKILL.md) 了解认证、身份切换和安全规则。
...
- [lark-shared](skills/lark-shared/SKILL.md) — 认证和全局参数
- [lark-skill-maker](skills/lark-skill-maker/SKILL.md) — 如需将挖掘到的 API 固化为新 Skill
