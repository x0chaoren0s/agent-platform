...
| Shortcut | 说明 |
|----------|------|
| [`+search`](skills/lark-drive/references/lark-drive-search.md) | Search Lark docs, Wiki, and spreadsheet files with flat filter flags (preferred over `docs +search`). Natural-language-friendly: `--edited-since`, `--mine`, `--doc-types`, etc. |
| [`+upload`](skills/lark-drive/references/lark-drive-upload.md) | Upload a local file to a Drive folder or wiki node |
| [`+create-folder`](skills/lark-drive/references/lark-drive-create-folder.md) | Create a Drive folder, optionally under a parent folder, with bot auto-grant support |
| [`+download`](skills/lark-drive/references/lark-drive-download.md) | Download a file from Drive to local |
| [`+create-shortcut`](skills/lark-drive/references/lark-drive-create-shortcut.md) | Create a shortcut to an existing Drive file in another folder |
| [`+add-comment`](skills/lark-drive/references/lark-drive-add-comment.md) | Add a comment to doc/docx/sheet/slides, also supports wiki URL resolving to doc/docx/sheet/slides |
| [`+export`](skills/lark-drive/references/lark-drive-export.md) | Export a doc/docx/sheet/bitable to a local file with limited polling |
| [`+export-download`](skills/lark-drive/references/lark-drive-export-download.md) | Download an exported file by file_token |
| [`+import`](skills/lark-drive/references/lark-drive-import.md) | Import a local file to Drive as a cloud document (docx, sheet, bitable) |
| [`+move`](skills/lark-drive/references/lark-drive-move.md) | Move a file or folder to another location in Drive |
| [`+delete`](skills/lark-drive/references/lark-drive-delete.md) | Delete a Drive file or folder with limited polling for folder deletes |
| [`+task_result`](skills/lark-drive/references/lark-drive-task-result.md) | Poll async task result for import, export, move, or delete operations |
| [`+apply-permission`](skills/lark-drive/references/lark-drive-apply-permission.md) | Apply to the document owner for view/edit access (user-only; 5/day per document) |
