...
**CRITICAL — 开始前 MUST 先用 Read 工具读取 [`skills/lark-shared/SKILL.md`](skills/lark-shared/SKILL.md)，其中包含认证、权限处理**。然后阅读 [`skills/lark-vc/SKILL.md`](skills/lark-vc/SKILL.md)，了解会议纪要相关操作。
...
阅读 [`skills/lark-doc/SKILL.md`](skills/lark-doc/SKILL.md) 学习云文档技能。
...
- [lark-shared](skills/lark-shared/SKILL.md) — 认证、权限（必读）
- [lark-vc](skills/lark-vc/SKILL.md) — `+search`、`+notes` 详细用法
- [lark-doc](skills/lark-doc/SKILL.md) — `+fetch`、`+create`、`+update` 详细用法